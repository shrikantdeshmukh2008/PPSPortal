...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ExceptionInfo> handleStock(InsufficientInventoryException iie,HttpServletRequest request) {
		logger.warn("Insufficient stock error for request {}: {}", request.getRequestURI(), iie.getMessage());
		ExceptionInfo info = new ExceptionInfo();
		info.setCode("EX-INV-001");
